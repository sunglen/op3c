...
<?php echo link_to_function(__('この小部件を添加する'), 'insertGadget(\''.$type.'\', \''.escape_javascript($key).'\', \'' . escape_javascript($value['caption']['ja_JP']) . '\')') ?>
</dt>
<dd><?php echo $value['description']['ja_JP'] ?></dd>
<?php endforeach; ?>
<?php else: ?>
<dt><?php echo __('小部件がありません') ?></dt>
<dd><?php echo __('添加できる小部件が登记されていません') ?></dd>
<?php endif; ?>
</dl>
