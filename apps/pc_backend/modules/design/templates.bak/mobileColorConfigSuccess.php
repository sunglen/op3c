...
<p class="caution" id="c01">※预设定颜色の呼出し後、かならず「色变更を确定する」を押し配色の设定を确定してください。</p>
...
<h3 class="item" id="subttl02">颜色コードの设定</h3>

<p class="caution" id="c02">※色の指定は16進数表記で行ってください。</p>
<p class="caution" id="c03">※色のプレビューが变更されてもそのままでは色设定は反映されません。必ず确定してください。</p>
...
<p class="textBtn" id="c04"><input type="submit" value="色变更を确定する" /></p>
