...
<p>そのテンプレート内で使用可能な変数は、各テンプレート编辑页の下部に一览してあります。</p>
...
<div class="example">
<h3>書式例</h3>
<p>以下は、 ID が 1 の成员の場合に特定の文言を表示させるサンプルになります。</p>
<pre><code>
{% if member.id == "1" %}
管理者の成员です。
{% endif %}
...
<p>members という配列の各要素に対して member という名字でアクセスしたい場合は <code>{% for members in member %}</code> というような記述になります。</p>

<div class="example">
<h3>書式例</h3>
<p>以下は、各成员の信息を格納した members という配列の各要素から昵称を取り出し、表示させるサンプルです。</p>
<pre><code>
&lt;ul&gt;
...
<p>より詳細な信息は <a href="http://www.twig-project.org/documentation" target="_blank">Twig</a> のドキュメントを参照してください。</p>
