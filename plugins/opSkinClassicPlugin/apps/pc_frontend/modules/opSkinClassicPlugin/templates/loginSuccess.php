...
<?php endforeach; ?>
<input type="image" name="submit" src="<?php echo image_path('dummy.gif') ?>" id="button_login" alt="登录" />
<?php if ($form->getAuthAdapter()->getAuthConfig('invite_mode') == 2 && opToolkit::isEnabledRegistration('pc')) : ?>
<?php echo link_to('<img src="'.image_path('dummy.gif').'" alt="注册新帐户" />', $form->getAuthAdapter()->getAuthConfig('self_invite_action'), array('id' => 'button_new_regist')) ?>
<?php endif; ?>
