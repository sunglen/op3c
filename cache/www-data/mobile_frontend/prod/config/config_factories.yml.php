...
// date: 2011/06/13 23:40:00
  ...
  {
    $class = sfConfig::get('sf_factory_i18n', 'opI18N');
    $cache = new sfFileCache(array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/sunge/op3c.20110406/cache/www-data/mobile_frontend/prod/i18n',
  'lifetime' => 86400,
  'prefix' => '/home/sunge/op3c.20110406/apps/mobile_frontend',
));
  ...
  $class = sfConfig::get('sf_factory_controller', 'opMobileFrontWebController');
   $this->factories['controller'] = new $class($this);
  $class = sfConfig::get('sf_factory_request', 'sfOpenPNEWebRequest');
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('OpenPNE_mobile_frontend'),
), sfConfig::get('sf_factory_storage_parameters', array (
  'session_name' => 'OpenPNE_mobile_frontend',
))));
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/sunge/op3c.20110406/cache/www-data/mobile_frontend/prod/template',
  'lifetime' => 86400,
  'prefix' => '/home/sunge/op3c.20110406/apps/mobile_frontend/template',
)));
